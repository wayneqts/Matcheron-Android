...
import com.appmonarchy.matcheron.databinding.FrmLikesBinding;
...
public class FrmLikes extends Fragment {
    FrmLikesBinding binding;
    Home activity;
    List<People> list;
    GridAdapter adapter;
    public FrmLikes() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FrmLikesBinding.inflate(getLayoutInflater());
        init();
    ...
    private void getData(){
        activity.api.getArrById("likes.php", activity.pref.getUserId()).enqueue(new Callback<JsonArray>() {
            @Override
